...
/**
 * The bombs dropped from Choppers. Fall more often than those from planes
 * 
 * @author Eric Stuppard
 * @version July 17, 2015
 */
public class ChopperBomb extends Bomb
{

    /**
     * Falls from Choppers, explodes when shot or when it hit the turret
     */
        public void act() 
    {
        World w = getWorld();
